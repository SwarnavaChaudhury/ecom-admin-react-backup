                ...
                <div className='m-5'>
                    ...
                    <div className='grid grid-cols-[30%_auto] gap-5'>
                        ...
                        <div>
                            ...
                            <select name="" id="" className='w-full rounded-md border-1 border-stone-400'>
                            ...
                            <select name="sub_cate_name" id="sub_cate_name" className='w-full rounded-md border-1 border-stone-400'>
                                <option value=""> Select Category </option>
                                <option value=""> Men </option>
                                <option value=""> Women </option>
                                <option value=""> Shoe </option>
                            ...
                            <input type="text" id='sub_sub_cate_name' placeholder='Enter Sub Sub-Category Name...' className='w-full rounded-md border-1 border-stone-400' />

                            <label htmlFor="sub_sub_cate_order" className='block my-2 font-bold'>
                                Sub Sub-Category Order
                            </label>
                            <input type="text" id='sub_sub_cate_order' placeholder='Enter Sub Sub-Category Order...' className='w-full rounded-md border-1 border-stone-400' />
                        </div>
                    </div>
