                ...
                <div className='m-5'>
                    ...
                    <div className='grid grid-cols-[30%_auto] gap-5'>
                        ...
                        <div>
                            ...
                            <input type="text" id='parent_cate_name' placeholder='Category Name...' className='w-full rounded-md border-1 border-stone-400' />

                            <label htmlFor="parent_cate_order" className='block my-2 font-bold'>
                                Parent Category Order
                            </label>
                            <input type="text" id='parent_cate_order' placeholder='Enter Category Order...' className='w-full rounded-md border-1 border-stone-400' />
                        </div>
                    </div>
