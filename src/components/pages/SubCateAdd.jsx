                            ...
                            <div className='m-5'>
                                ...
                                <div className='grid grid-cols-[30%_auto] gap-5'>
                                    ...
                                    <div>
                                        ...
                                        <input type="text" id='sub_cate_name' placeholder='Sub-Category Name...' className='w-full rounded-md border-1 border-stone-400' />

                                        <label htmlFor="sub_cate_order" className='block my-2 font-bold'>
                                            Sub-Category Order
                                        </label>
                                        <input type="text" id='sub_cate_order' placeholder='Sub-Category Order...' className='w-full rounded-md border-1 border-stone-400' />
                                    </div>
                                </div>
